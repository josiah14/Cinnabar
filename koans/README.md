...
| `advanced/` | 01-ffi, 02-existential-escape, 03-impure-foreign-proc, 04-univ-det, 05-export-arity, 06-foreign-enum, 07-solver-any-inst, 08-ffi-mutex (text) |

---

**Adding a koan?** See [`docs/TEMPLATES.md`](../docs/TEMPLATES.md) for the canonical section order (the *Koan* template).
